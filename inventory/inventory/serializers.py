...
from .models import Category,Item, Location, ReturnRecall, StockMovement,Supply,Store,ItemImage
...
class ItemSerializer(serializers.ModelSerializer):
    class Meta:
        model=Item
        fields=['id','name','description','category','barcode','is_returnable','notify_below','isvisible']
...
class SupplySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model=Supply
        fields=['id','item','quantity','unit','cost_price','sale_price','expiration_date','batch_number','man_date','store','supplier_id']
